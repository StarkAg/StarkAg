...
- **[rydvue](https://github.com/StarkAg/rydvue)**  <sub>yesterday</sub>
...
- **[GradeX](https://github.com/StarkAg/GradeX)** — Student portal for SRM University serving 9,000+ students — timetable, attendance, marks, exam-seat finder. Sub-1s cached responses (Go + Redis). Android app on Google Play. Live: gradex.bond  <sub>4 days ago</sub>
- **[VentArc](https://github.com/StarkAg/VentArc)** — Event management platform — React, Express, Convex (includes CertVault certificate hosting/verification)  <sub>5 days ago</sub>
- **[Found404-Ultron-8.0](https://github.com/StarkAg/Found404-Ultron-8.0)** — Ultron Hackathon submission by CodeRaptors team  <sub>6 days ago</sub>
<!-- recent-activity:end -->
